...
import {FormGroup,ControlLabel,FormControl,Checkbox, ButtonGroup, Button, Form, Col, FieldGroup} from 'react-bootstrap';
import NavBar from './NavBar';

class ChatCust extends React.Component {
    ...
    render() {
        ...
        <div>
            <NavBar/>
            <header><h2>Chat With Restautant</h2></header>
